...
class Tracer:
    ...
    def run(self, tid = 0):
    # Python on Thoth (V2.6) does not support dictionary comprehensions (@zth6)
...
def run(name, args):
    ...
    optlist, args = getopt.getopt(args, 'hp:t:v:Aw')
    ...
    if not levelFixed and autograde:
        vlevel = 0
    if not noWarn:
        print("Warning! Don't run this script directly! instead do\n\t$ make test\n to run all automated tests.")
